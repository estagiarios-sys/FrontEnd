...
export default function View() {
  useEffect(() => {
    ...
    const inputs = [{titulo: 'teste' , op_produto: '10', qrcode: 'https://systextil.com.br/', barcodes: 'https://systextil.com.br/', infos: 'Informações Genéricas...', line_1: 'teste', line_2: 'teste', table: 'teste'}];

    const viewer = new Viewer({ domContainer: domContainer ?? document.body, template, inputs });
    
    if (domContainer instanceof HTMLElement) {
      const viewer = new Viewer({ domContainer, template, inputs });
    } else {
      // handle the case where domContainer is null
