      ...
      const inputs = [
        {
          table: table[0].values.map((_, rowIndex) => 
            table.map(col => col.values[rowIndex]) // Garante que os valores estejam alinhados corretamente
          ),
          ...
          titulo: 'Título Aqui',
          qrcode: 'https://systextil.com.br/', // Conteúdo do QR code
          barcodes: '1234567890', // Conteúdo do código de barras (deve ser numérico para code128)
        }
      ];
        ...
        if (domContainer) {
          new Viewer({
            ...
            plugins: {
              ...
              text,          
              Table: tableBeta,
              qrcode: barcodes.qrcode, // Plugin para gerar o QR code
              barcode: barcodes.code128, // Plugin para gerar o código de barras
            }
          });
        } else {
